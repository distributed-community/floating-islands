...
Остров - группа объединеных жесткими или короткими (до 10 метров) полужесткими соединениями с общей инфраструктурой типа воды и электричества.

Юнит - базовая еденица острова в которой меряется площадь и происходит прирастание острова.  базовой еденицей считать квадрат или 6-угольник со стороной 12м.  могут иметь кратные размеры. например шестигранник со стороной в 24м.

Модуль - кострукционная еденица юнита, которую удобно перевозить и в принципе может самостоятельно плыть (но не обязательно). Например прямоугольник 12*2.4 или треугольник со стороной 12.
